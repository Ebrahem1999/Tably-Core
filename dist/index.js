  ...
  return /* @__PURE__ */ r.jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ r.jsxs("div", { className: "flex gap-2 overflow-x-auto py-3 px-2 no-scrollbar scroll-smooth", children: [
      /* @__PURE__ */ r.jsx(
        "button",
        {
          className: `tab ${e === "all" ? "bg-blue-500/20 border-blue-400/50 text-blue-400 ring-2 ring-blue-400/30" : "hover:bg-white/5"} transition-all duration-200`,
          onClick: () => t("all"),
          children: s("all")
        }
      ),
      n.map((a) => /* @__PURE__ */ r.jsxs(
        "button",
        {
          className: `tab ${e === a.id ? "bg-blue-500/20 border-blue-400/50 text-blue-400 ring-2 ring-blue-400/30" : "hover:bg-white/5"} transition-all duration-200`,
          onClick: () => t(a.id),
          children: [
