...
function qf({ open: n, onClose: e, menuData: t }) {
...
J.loadNamespaces;
J.loadLanguages;
const Nr = "New order from template menu", $r = "Total", Cr = "Name", Sr = "Type", Er = "Time/Table", kr = "Size", Rr = "Extras", Or = "Notes", Pr = "Doneness", Ar = "Sugar", Tr = "Pasta Type", Lr = "Bread", Mr = "Menu", Ir = "Contact", Fr = "All", zr = "Search dishes...", Ur = "Call", Dr = "WhatsApp", Vr = "Location", Br = "Address", qr = "Opening Hours", Wr = "Add to Cart", Hr = "Added", Kr = "Customize", Yr = "Size", Jr = "Extras", Qr = "Notes", Gr = "Cart", Xr = "items", Zr = "Your cart is empty", ea = "Clear cart", ta = "Send via WhatsApp", sa = "Total", na = "Name", ra = "Order type", aa = "Pickup", ia = "Delivery", oa = "Time/Table", ca = "Message preview", la = "QR", ua = "Instagram", da = "Base price", fa = "Extras", ha = "Reservation", pa = "Book a Table", ma = "Date", ga = "Time", _a = "Area", xa = "Number of Guests", ya = "Your Name", ba = "Phone Number", va = "Special Requests", wa = "Send Reservation Request", ja = "Reservation request sent!", Na = "Please wait for confirmation from the restaurant.", $a = "If you don't receive a response within 15 minutes, please call the restaurant.", Ca = "Please wait for confirmation from the restaurant for your order.", Sa = "If you don't receive a response within 5 minutes, please call the restaurant.", Ea = "Today", ka = "Tomorrow", Ra = "Reserve your table at our restaurant and enjoy an unforgettable dining experience. We look forward to welcoming you!", Oa = "Choose your preferred date", Pa = "Select time slot", Aa = "Number of people", Ta = "Important Notice", La = "Need immediate assistance? Call us:", Ma = "Any special requests or notes...", Ia = "Guest", Fa = "Guests", za = "Table Reservation Request", Ua = "Date:", Da = "Time:", Va = "Area:", Ba = "Guests:", qa = "Name:", Wa = "Phone:", Ha = "Notes:", Ka = "Please confirm this reservation.", Ya = "Thank you! 🙏", Ja = "Sun–Thu:", Qa = "Fri:", Ga = "Sat:", Xa = "Important Notice", Za = "Delivery fees not included in total price", ei = "Continue to WhatsApp", ti = "Cancel", si = "🍽️ NEW ORDER REQUEST", ni = "📋 ORDER ITEMS:", ri = "👤 CUSTOMER INFORMATION:", ai = "Order Type", ii = "Name", oi = "Phone", ci = "Qty", li = "Item", ui = "Options", di = "Please confirm this order. Thank you! 🙏", fi = "Served until 13:00", hi = "Sunday", pi = "Monday", mi = "Tuesday", gi = "Wednesday", _i = "Thursday", xi = "Friday", yi = "Saturday", bi = "Terms of Service", vi = "Privacy Policy", wi = "Accessibility Statement", ji = "Last updated", Ni = "Acceptance of Terms", $i = "By using our website and services, you agree to comply with these terms of service.", Ci = "Service Usage", Si = "Our website is designed for browsing our menu, placing orders via WhatsApp, and making reservations.", Ei = "Orders and Reservations", ki = "All orders are processed through WhatsApp. Reservations are subject to availability and confirmation.", Ri = "Payment Terms", Oi = "Payment is handled directly at the restaurant. Online orders are for convenience and confirmation only.", Pi = "Limitation of Liability", Ai = "We are not responsible for third-party services such as WhatsApp. Use of external services is subject to their terms.", Ti = "Changes to Terms", Li = "We may update these terms from time to time. Continued use constitutes acceptance of revised terms.", Mi = "Information Collection", Ii = "We respect your privacy. Our website does not use cookies or online tracking. Information is stored locally in your browser (LocalStorage) for continuity, and may include name and order preferences (personal/family).", Fi = "Information Usage", zi = "We only use information to provide our services and improve your experience. We do not share personal data with third parties.", Ui = "Cookies and Tracking", Di = "Our website does not use cookies or tracking technologies. All data is stored locally in your browser.", Vi = "WhatsApp Integration", Bi = "Order placement occurs through WhatsApp (external service). WhatsApp usage is subject to WhatsApp's terms and privacy policy.", qi = "Data Storage", Wi = "Data is stored locally on your device and on WhatsApp for order processing and communication purposes.", Hi = "User Rights", Ki = "For any questions or requests regarding your data, please contact us through our contact page.", Yi = "Our Commitment", Ji = "We are committed to making our website accessible according to Israeli Standard TI 5568 based on WCAG 2.0 Level AA. Our goal is to provide an accessible, equal, and comfortable user experience for all users.", Qi = "Accessibility Standards", Gi = "Our website follows modern accessibility guidelines including keyboard navigation, screen reader compatibility, and clear visual design.", Xi = "Accessibility Features", Zi = "The website includes proper heading structure, alternative text for images, keyboard navigation support, and responsive design for various devices and assistive technologies.", eo = "Accessibility Contact", to = "If you encounter any accessibility issues or have suggestions for improvement, please contact us via phone or WhatsApp listed on our contact page.", so = "Customer name is required before sending to WhatsApp", no = "Back to Menu", ro = "The restaurant is currently closed. Please try again during opening hours.", ao = "Close", io = "Closed", oo = "The restaurant is currently closed. Orders can be placed only during opening hours.", co = "Got it", lo = {
  wa_header: Nr,
  wa_total: $r,
  wa_name: Cr,
  wa_type: Sr,
  ...
  day_fri: xi,
  day_sat: yi,
  "day_tue-sun": "Tuesday-Sunday",
  terms_of_service: bi,
  privacy_policy: vi,
  accessibility_statement: wi,
  last_updated: ji,
  terms_acceptance: Ni,
  terms_acceptance_text: $i,
  terms_service_usage: Ci,
  terms_service_usage_text: Si,
  terms_orders: Ei,
  terms_orders_text: ki,
  terms_payment: Ri,
  terms_payment_text: Oi,
  terms_liability: Pi,
  terms_liability_text: Ai,
  terms_changes: Ti,
  terms_changes_text: Li,
  privacy_info_collection: Mi,
  privacy_info_collection_text: Ii,
  privacy_info_usage: Fi,
  privacy_info_usage_text: zi,
  privacy_cookies: Ui,
  privacy_cookies_text: Di,
  privacy_whatsapp: Vi,
  privacy_whatsapp_text: Bi,
  privacy_data_storage: qi,
  privacy_data_storage_text: Wi,
  privacy_user_rights: Hi,
  privacy_user_rights_text: Ki,
  accessibility_commitment: Yi,
  accessibility_commitment_text: Ji,
  accessibility_standards: Qi,
  accessibility_standards_text: Gi,
  accessibility_features: Xi,
  accessibility_features_text: Zi,
  accessibility_contact: eo,
  accessibility_contact_text: to,
  name_required: so,
  back_to_menu: no,
  restaurant_closed_message: ro,
  close: ao,
  closed: io,
  closed_popup_message: oo,
  got_it_button: co
}, uo = "הזמנה חדשה מתפריט התבנית", fo = "סך הכול", ho = "שם", po = "סוג", mo = "שעה/שולחן", go = "גודל", _o = "תוספות", xo = "הערות", yo = "דרגת עשייה", bo = "סוכר", vo = "סוג פסטה", wo = "לחם", jo = "תפריט", No = "צור קשר", $o = "הכל", Co = "חיפוש מנות...", So = "התקשר", Eo = "וואטסאפ", ko = "מיקום", Ro = "כתובת", Oo = "שעות פתיחה", Po = "להוסיף לסל", Ao = "נוסף", To = "התאמה", Lo = "גודל", Mo = "תוספות", Io = "הערות", Fo = "הסל", zo = "פריטים", Uo = "הסל ריק", Do = "נקה סל", Vo = "שלח בוואטסאפ", Bo = "סך הכל", qo = "שם", Wo = "סוג הזמנה", Ho = "איסוף עצמי", Ko = "משלוח", Yo = "שעה/שולחן", Jo = "תצוגה מקדימה", Qo = "QR", Go = "אינסטגרם", Xo = "מחיר בסיס", Zo = "תוספות", ec = "הזמנת שולחן", tc = "הזמן שולחן", sc = "תאריך", nc = "שעה", rc = "אזור", ac = "מספר אורחים", ic = "השם שלך", oc = "מספר טלפון", cc = "בקשות מיוחדות", lc = "שלח בקשת הזמנה", uc = "בקשת ההזמנה נשלחה!", dc = "אנא המתן לאישור מהמסעדה.", fc = "אם לא תקבל תגובה תוך 15 דקות, אנא התקשר למסעדה.", hc = "אנא המתן לאישור מהמסעדה עבור ההזמנה שלך.", pc = "אם לא תקבל תגובה תוך 5 דקות, אנא התקשר למסעדה.", mc = "היום", gc = "מחר", _c = "הזמן שולחן במסעדה שלנו ותהנה מחווית אוכל בלתי נשכחת. אנחנו מצפים לראות אותך!", xc = "בחר את התאריך המועדף עליך", yc = "בחר זמן", bc = "מספר אנשים", vc = "הודעה חשובה", wc = "צריך עזרה מיידית? התקשר אלינו:", jc = "בקשות מיוחדות או הערות...", Nc = "אורח", $c = "אורחים", Cc = "בקשת הזמנת שולחן", Sc = "תאריך:", Ec = "שעה:", kc = "אזור:", Rc = "אורחים:", Oc = "שם:", Pc = "טלפון:", Ac = "הערות:", Tc = "אנא אשר את ההזמנה הזו.", Lc = "תודה! 🙏", Mc = "א׳-ה׳:", Ic = "ו׳:", Fc = "ש׳:", zc = "הודעה חשובה", Uc = "עמלת משלוח לא כלולה במחיר הכולל", Dc = "המשך לווטסאפ", Vc = "ביטול", Bc = "🍽️ בקשת הזמנה חדשה", qc = "📋 פריטי ההזמנה:", Wc = "👤 פרטי הלקוח:", Hc = "סוג הזמנה", Kc = "שם", Yc = "טלפון", Jc = "כמות", Qc = "פריט", Gc = "אפשרויות", Xc = "אנא אשר את ההזמנה הזו. תודה! 🙏", Zc = "מוגש עד 13:00", el = "ראשון", tl = "שני", sl = "שלישי", nl = "רביעי", rl = "חמישי", al = "שישי", il = "שבת", ol = "תנאי שימוש", cl = "מדיניות פרטיות", ll = "הצהרת נגישות", ul = "תאריך עדכון אחרון", dl = "אחריות", fl = "אין אחריות לשירותי צד-שלישי (כגון WhatsApp). כל שימוש בשירותים חיצוניים כפוף לתנאורים.", hl = "שינויים בתנאים", pl = "יתכן שנעדכן שינויים בתנאי השימוש מעת לעת. המשך השימוש כהסכמה לתנאים כפופה.", ml = "יצירת קשר בנושא נגישות", gl = "אם נתקלתם בבעיה או הצעה לשיפור, נעמוד לכפות אליכן בטלפון או בוואטסאפ המופיעים במיקום יצירת קשר.", _l = "מטרת עיכוב היחידי", xl = "האתר מכיל לפרטים, בחירת פריטים, והזמנת מקום לוואטסאפ של המטעדה.", yl = "זכויות המשתמש", bl = "כפי שלאה או בקשה לחתיקה מידע, נעמוד לכפות אליכן דרך עמוד יצירת קשר.", vl = "תאריך עדכון אחרון", wl = "26.9.2025", jl = "אחריות", Nl = "אין אחריות לשירותי צד-שלישי (כגון WhatsApp). כל שימוש בשירותים חיצוניים כפוף לתנאורים.", $l = "שינויים בתנאים", Cl = "יתכן שנעדכן שינויים בתנאי השימוש מעת לעת. המשך השימוש כהסכמה לתנאים כפופה.", Sl = "מדיניות פרטיות", El = "אנו מכבדים את פרטיותכם. האתר אינו מפעיל עוגיות (cookies) ואינו מבצע מעקב אינטרנטי. המידע שמורן בעלות הקרייות ומורה מקומית בדפדפן (LocalStorage) לצורך המשכיות כבב, ויכול לכלול שם ופוטר המנה (אישי/משפחה).", kl = "מטרת עיכוב היחידי", Rl = "שליחת הזמנה/פנירה מתבצעת באמצעות WhatsApp (שירות חיצוני). על כן, השימוש ב-WhatsApp כפוף לתנאי השימוש ומדיניות הפרטיות של WhatsApp.", Ol = "מטרת עיכוב היחידי", Pl = "האתר מכיל לפרטים, בחירת פריטים, והזמנת מקום לוואטסאפ של המטעדה.", Al = "זכויות המשתמש", Tl = "כפי שלאה או בקשה לחתיקה מידע, נעמוד לכפות אליכן דרך עמוד יצירת קשר.", Ll = "הצהרת נגישות", Ml = 'אנו פועלים להנגיש את האתר בהתאם לתקן הישראלי ת"י 5568 הכמבוס על 2.0 WCAG ברמה AA. מטרתנו להנביח חווית שימוש נגישה, שוויונית ונוחה לכלל המשתמשים.', Il = "יצירת קשר בנושא נגישות", Fl = "אם נתקלתם בבעיה או הצעה לשיפור, נעמוד לכפות אליכן בטלפון או בוואטסאפ המופיעים במיקום יצירת קשר.", zl = "מטרת עיכוב היחידי", Ul = "האתר מכיל לפרטים, בחירת פריטים, והזמנת מקום לוואטסאפ של המטעדה.", Dl = "יצירת קשר בנושא נגישות", Vl = "אם נתקלתם בבעיה או הצעה לשיפור, נעמוד לכפות אליכן בטלפון או בוואטסאפ המופיעים במיקום יצירת קשר.", Bl = "שם הלקוח נדרש לפני שליחה לוואטסאפ", ql = "חזרה לתפריט", Wl = "סגור", Hl = "המסעדה סגורה כעת. נסה שוב בשעות הפתיחה.", Kl = "סגור", Yl = "המסעדה סגורה כעת. ניתן לבצע הזמנות רק במהלך שעות הפתיחה.", Jl = "הבנתי", Ql = {
  wa_header: uo,
  wa_total: fo,
  wa_name: ho,
  wa_type: po,
  ...
  reservation_time: nc,
  reservation_area: rc,
  reservation_guests: ac,
  reservation_name: ic,
  reservation_phone: oc,
  reservation_notes: cc,
  send_reservation: lc,
  reservation_sent: uc,
  reservation_wait: dc,
  reservation_no_response: fc,
  order_wait: hc,
  order_no_response: pc,
  today: mc,
  tomorrow: gc,
  reservation_description: _c,
  choose_date: xc,
  select_time: yc,
  number_people: bc,
  important_notice: vc,
  need_assistance: wc,
  special_requests_placeholder: jc,
  guests_singular: Nc,
  guests_plural: $c,
  reservation_request: Cc,
  date_label: Sc,
  time_label: Ec,
  area_label: kc,
  guests_label: Rc,
  ...
  phone_label: Pc,
  notes_label: Ac,
  confirm_reservation: Tc,
  thank_you: Lc,
  sun_thu: Mc,
  fri: Ic,
  sat: Fc,
  important_notice_cart: zc,
  delivery_notice: Uc,
  continue_to_whatsapp: Dc,
  cancel: Vc,
  wa_order_header: Bc,
  wa_order_items: qc,
  wa_customer_info: Wc,
  ...
  day_fri: al,
  day_sat: il,
  "day_tue-sun": "שלישי-ראשון",
  terms_of_service: ol,
  privacy_policy: cl,
  accessibility_statement: ll,
  last_updated: ul,
  terms_acceptance: dl,
  terms_acceptance_text: fl,
  terms_service_usage: hl,
  terms_service_usage_text: pl,
  terms_orders: ml,
  terms_orders_text: gl,
  terms_payment: _l,
  terms_payment_text: xl,
  terms_liability: yl,
  terms_liability_text: bl,
  terms_changes: vl,
  terms_changes_text: wl,
  privacy_info_collection: jl,
  privacy_info_collection_text: Nl,
  privacy_info_usage: $l,
  privacy_info_usage_text: Cl,
  privacy_cookies: Sl,
  privacy_cookies_text: El,
  privacy_whatsapp: kl,
  privacy_whatsapp_text: Rl,
  privacy_data_storage: Ol,
  privacy_data_storage_text: Pl,
  privacy_user_rights: Al,
  privacy_user_rights_text: Tl,
  accessibility_commitment: Ll,
  accessibility_commitment_text: Ml,
  accessibility_standards: Il,
  accessibility_standards_text: Fl,
  accessibility_features: zl,
  accessibility_features_text: Ul,
  accessibility_contact: Dl,
  accessibility_contact_text: Vl,
  name_required: Bl,
  back_to_menu: ql,
  closed: Wl,
  restaurant_closed_message: Hl,
  close: Kl,
  closed_popup_message: Yl,
  got_it_button: Jl
}, Gl = "طلب جديد عبر قائمة القالب", Xl = "الإجمالي", Zl = "الاسم", eu = "النوع", tu = "ساعة/طاولة", su = "الحجم", nu = "إضافات", ru = "ملاحظات", au = "درجة الاستواء", iu = "سكر", ou = "نوع المعكرونة", cu = "الخبز", lu = "القائمة", uu = "تواصل", du = "الكل", fu = "ابحث عن طبق...", hu = "اتصال", pu = "واتساب", mu = "الموقع", gu = "العنوان", _u = "ساعات العمل", xu = "أضف إلى السلة", yu = "تمت الإضافة", bu = "تخصيص", vu = "الحجم", wu = "إضافات", ju = "ملاحظات", Nu = "السلة", $u = "عنصر", Cu = "السلة فارغة", Su = "تفريغ السلة", Eu = "إرسال عبر واتساب", ku = "الإجمالي", Ru = "الاسم", Ou = "نوع الطلب", Pu = "استلام", Au = "توصيل", Tu = "ساعة/طاولة", Lu = "نص الرسالة", Mu = "QR", Iu = "إنستغرام", Fu = "السعر الأساسي", zu = "الإضافات", Uu = "حجز طاولة", Du = "احجز طاولة", Vu = "التاريخ", Bu = "الوقت", qu = "المنطقة", Wu = "عدد الضيوف", Hu = "اسمك", Ku = "رقم الهاتف", Yu = "طلبات خاصة", Ju = "إرسال طلب الحجز", Qu = "تم إرسال طلب الحجز!", Gu = "يرجى انتظار التأكيد من المطعم.", Xu = "إذا لم تتلق رداً خلال 15 دقيقة، يرجى الاتصال بالمطعم.", Zu = "يرجى انتظار التأكيد من المطعم لطلبك.", ed = "إذا لم تتلق رداً خلال 5 دقائق، يرجى الاتصال بالمطعم.", td = "اليوم", sd = "غداً", nd = "احجز طاولتك في مطعمنا واستمتع بتجربة طعام لا تُنسى. نحن نتطلع لاستقبالك!", rd = "اختر التاريخ المفضل لديك", ad = "اختر الوقت", id = "عدد الأشخاص", od = "إشعار مهم", cd = "تحتاج مساعدة فورية؟ اتصل بنا:", ld = "أي طلبات خاصة أو ملاحظات...", ud = "ضيف", dd = "ضيوف", fd = "طلب حجز طاولة", hd = "التاريخ:", pd = "الوقت:", md = "المنطقة:", gd = "الضيوف:", _d = "الاسم:", xd = "الهاتف:", yd = "ملاحظات:", bd = "يرجى تأكيد هذا الحجز.", vd = "شكراً لك! 🙏", wd = "الأحد-الخميس:", jd = "الجمعة:", Nd = "السبت:", $d = "إشعار مهم", Cd = "رسوم التوصيل غير مشمولة في السعر الإجمالي", Sd = "متابعة إلى واتساب", Ed = "إلغاء", kd = "🍽️ طلب جديد", Rd = "📋 عناصر الطلب:", Od = "👤 معلومات العميل:", Pd = "نوع الطلب", Ad = "الاسم", Td = "الهاتف", Ld = "الكمية", Md = "العنصر", Id = "الخيارات", Fd = "يرجى تأكيد هذا الطلب. شكراً لك! 🙏", zd = "يُقدم حتى 13:00", Ud = "الأحد", Dd = "الاثنين", Vd = "الثلاثاء", Bd = "الأربعاء", qd = "الخميس", Wd = "الجمعة", Hd = "السبت", Kd = "شروط الخدمة", Yd = "سياسة الخصوصية", Jd = "بيان إمكانية الوصول", Qd = "آخر تحديث", Gd = "قبول الشروط", Xd = "باستخدام موقعنا وخدماتنا، فإنك توافق على الالتزام بشروط الخدمة هذه.", Zd = "استخدام الخدمة", ef = "تم تصميم موقعنا لتصفح القائمة وتقديم الطلبات عبر واتساب وإجراء الحجوزات.", tf = "الطلبات والحجوزات", sf = "جميع الطلبات تتم معالجتها عبر واتساب. الحجوزات تخضع للتوفر والتأكيد.", nf = "شروط الدفع", rf = "يتم التعامل مع الدفع مباشرة في المطعم. الطلبات عبر الإنترنت للراحة والتأكيد فقط.", af = "حدود المسؤولية", of = "نحن غير مسؤولين عن خدمات الطرف الثالث مثل واتساب. استخدام الخدمات الخارجية يخضع لشروطها.", cf = "تغييرات الشروط", lf = "قد نقوم بتحديث هذه الشروط من وقت لآخر. الاستخدام المستمر يشكل قبولاً للشروط المنقحة.", uf = "جمع المعلومات", df = "نحن نحترم خصوصيتك. موقعنا لا يستخدم ملفات تعريف الارتباط أو التتبع عبر الإنترنت. يتم تخزين المعلومات محلياً في متصفحك للاستمرارية، وقد تشمل الاسم وتفضيلات الطلب.", ff = "استخدام المعلومات", hf = "نستخدم المعلومات فقط لتقديم خدماتنا وتحسين تجربتك. لا نشارك البيانات الشخصية مع أطراف ثالثة.", pf = "ملفات تعريف الارتباط والتتبع", mf = "موقعنا لا يستخدم ملفات تعريف الارتباط أو تقنيات التتبع. جميع البيانات مخزنة محلياً في متصفحك.", gf = "تكامل واتساب", _f = "تقديم الطلبات يتم عبر واتساب (خدمة خارجية). استخدام واتساب يخضع لشروط وسياسة خصوصية واتساب.", xf = "تخزين البيانات", yf = "يتم تخزين البيانات محلياً على جهازك وعلى واتساب لمعالجة الطلبات وأغراض التواصل.", bf = "حقوق المستخدم", vf = "لأي أسئلة أو طلبات بخصوص بياناتك، يرجى التواصل معنا عبر صفحة الاتصال.", wf = "التزامنا", jf = "نحن ملتزمون بجعل موقعنا قابلاً للوصول وفقاً للمعايير الحديثة. هدفنا توفير تجربة مستخدم متاحة ومتساوية ومريحة لجميع المستخدمين.", Nf = "معايير إمكانية الوصول", $f = "يتبع موقعنا إرشادات إمكانية الوصول الحديثة بما في ذلك التنقل بلوحة المفاتيح وتوافق قارئ الشاشة والتصميم البصري الواضح.", Cf = "ميزات إمكانية الوصول", Sf = "يتضمن الموقع هيكل عناوين مناسب ونص بديل للصور ودعم التنقل بلوحة المفاتيح وتصميم متجاوب لمختلف الأجهزة والتقنيات المساعدة.", Ef = "التواصل بخصوص إمكانية الوصول", kf = "إذا واجهت أي مشاكل في إمكانية الوصول أو لديك اقتراحات للتحسين، يرجى التواصل معنا عبر الهاتف أو واتساب المدرجين في صفحة الاتصال.", Rf = "اسم العميل مطلوب قبل الإرسال إلى واتساب", Of = "العودة إلى القائمة", Pf = "مغلق", Af = "المطعم مغلق حالياً. الرجاء المحاولة خلال ساعات العمل.", Tf = "إغلاق", Lf = "المطعم مغلق حالياً. يمكن تقديم الطلبات فقط خلال ساعات العمل.", Mf = "حسنًا", If = {
  wa_header: Gl,
  wa_total: Xl,
  wa_name: Zl,
  wa_type: eu,
  ...
  reservation_time: Bu,
  reservation_area: qu,
  reservation_guests: Wu,
  reservation_name: Hu,
  reservation_phone: Ku,
  reservation_notes: Yu,
  send_reservation: Ju,
  reservation_sent: Qu,
  reservation_wait: Gu,
  reservation_no_response: Xu,
  order_wait: Zu,
  order_no_response: ed,
  today: td,
  tomorrow: sd,
  reservation_description: nd,
  choose_date: rd,
  select_time: ad,
  number_people: id,
  important_notice: od,
  need_assistance: cd,
  special_requests_placeholder: ld,
  guests_singular: ud,
  guests_plural: dd,
  reservation_request: fd,
  date_label: hd,
  time_label: pd,
  area_label: md,
  guests_label: gd,
  ...
  phone_label: xd,
  notes_label: yd,
  confirm_reservation: bd,
  thank_you: vd,
  sun_thu: wd,
  fri: jd,
  sat: Nd,
  important_notice_cart: $d,
  delivery_notice: Cd,
  continue_to_whatsapp: Sd,
  cancel: Ed,
  wa_order_header: kd,
  wa_order_items: Rd,
  wa_customer_info: Od,
  ...
  day_fri: Wd,
  day_sat: Hd,
  "day_tue-sun": "الثلاثاء-الاحد",
  terms_of_service: Kd,
  privacy_policy: Yd,
  accessibility_statement: Jd,
  last_updated: Qd,
  terms_acceptance: Gd,
  terms_acceptance_text: Xd,
  terms_service_usage: Zd,
  terms_service_usage_text: ef,
  terms_orders: tf,
  terms_orders_text: sf,
  terms_payment: nf,
  terms_payment_text: rf,
  terms_liability: af,
  terms_liability_text: of,
  terms_changes: cf,
  terms_changes_text: lf,
  privacy_info_collection: uf,
  privacy_info_collection_text: df,
  privacy_info_usage: ff,
  privacy_info_usage_text: hf,
  privacy_cookies: pf,
  privacy_cookies_text: mf,
  privacy_whatsapp: gf,
  privacy_whatsapp_text: _f,
  privacy_data_storage: xf,
  privacy_data_storage_text: yf,
  privacy_user_rights: bf,
  privacy_user_rights_text: vf,
  accessibility_commitment: wf,
  accessibility_commitment_text: jf,
  accessibility_standards: Nf,
  accessibility_standards_text: $f,
  accessibility_features: Cf,
  accessibility_features_text: Sf,
  accessibility_contact: Ef,
  accessibility_contact_text: kf,
  name_required: Rf,
  back_to_menu: Of,
  closed: Pf,
  restaurant_closed_message: Af,
  close: Tf,
  closed_popup_message: Lf,
  got_it_button: Mf
}, Ff = {
  en: { translation: lo },
  he: { translation: Ql },
...
export {
  Hf as AccessibilityPage,
  Wf as AnimationProvider,
  Bf as CartButton,
  qf as CartDrawer,
  Vf as CartProvider,
  Bn as CategoryTabs,
